...
class AppStateNotifier extends ChangeNotifier {
  ...
  MemChatAuthUser? initialUser;
  MemChatAuthUser? user;
  ...
  void update(MemChatAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Recover',
          path: '/recover',
          builder: (context, params) => const RecoverWidget(),
        ),
        FFRoute(
          name: 'Register',
          path: '/register',
        ...
        FFRoute(
          ...
          builder: (context, params) => CompleteProfileWidget(
            tempPin: params.getParam('tempPin', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'Chat',
        ...
        FFRoute(
          ...
          path: '/groups',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Groups')
              : const GroupsWidget(),
        ),
        FFRoute(
          name: 'Requests',
          path: '/requests',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Requests')
        ...
        FFRoute(
          ...
          path: '/updates',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Updates')
              : const UpdatesWidget(),
        ),
        FFRoute(
          name: 'StatusView',
          path: '/statusView',
          builder: (context, params) => const StatusViewWidget(),
        )
