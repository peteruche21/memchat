...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    memChatAuthUserSubject.add(
      MemChatAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MemChatAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MemChatAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MemChatAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    memChatAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
