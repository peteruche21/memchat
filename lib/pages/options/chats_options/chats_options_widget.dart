...
import 'chats_options_model.dart';
export 'chats_options_model.dart';

class ChatsOptionsWidget extends StatefulWidget {
  const ChatsOptionsWidget({super.key});
...
class _ChatsOptionsWidgetState extends State<ChatsOptionsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatsOptionsModel());
  }
